 ...
 */
	...
	$facebook_like .= $form->field($model, 'facebook_like_url')->textInput();

	$facebook_like .= $form->field($model, 'facebook_like_title')->textInput(
		['value' => 'мне нравится']
	);
	...
	$facebook_share .= $form->field($model, 'facebook_share_url')->textInput();

	$facebook_share .= $form->field($model, 'facebook_share_title')->textInput(
		['value' => 'поделиться']
	);
	...
	$facebook_share .= $form->field($model, 'facebook_share_message_name')->textInput();
	$facebook_share .= $form->field($model, 'facebook_share_message_caption')->textInput();
	$facebook_share .= $form->field($model, 'facebook_share_message_description')->textInput();
	$facebook_share .= $form->field($model, 'facebook_share_message_image')->textInput();
	...
	$twitter_tweet .= $form->field($model, 'twitter_tweet_url')->textInput();
	$twitter_tweet .= $form->field($model, 'twitter_tweet_text')->textarea();
	...
	$twitter_tweet .= $form->field($model, 'twitter_tweet_via')->textInput();
	$twitter_tweet .= $form->field($model, 'twitter_tweet_title')->textInput(
		['value' => 'твитнуть']
	);
	...
	$twitter_follow .= $form->field($model, 'twitter_follow_url')->textInput();
	...
	$twitter_follow .= $form->field($model, 'twitter_follow_hide_name')->textInput();
	$twitter_follow .= $form->field($model, 'twitter_follow_title')->textInput(
		['value' => 'подписаться']
	);
	...
	$google_plus .= $form->field($model, 'google_plus_url')->textInput();

	$google_plus .= $form->field($model, 'google_plus_title')->textInput(
		['value' => 'плюсануть']
	);
	...
	$google_share .= $form->field($model, 'google_share_url')->textInput();

	$google_share .= $form->field($model, 'google_share_title')->textInput(
		['value' => 'поделиться']
	);
	...
	$google_youtube .= $form->field($model, 'google_youtube_channel_id')->textInput();

	$google_youtube .= $form->field($model, 'google_youtube_title')->textInput(
		['value' => 'подписаться']
	);
	...
	$linkedin_share .= $form->field($model, 'linkedin_share_url')->textInput();

	$linkedin_share .= $form->field($model, 'linkedin_share_title')->textInput(
		['value' => 'подписаться']
	);
	...
	$vk_like .= $form->field($model, 'vk_like_url')->textInput();

	$vk_like .= $form->field($model, 'vk_like_title')->textInput(
			['value' => 'мне нравится']
	);

	$vk_like .= $form->field($model, 'vk_like_message_title')->textInput();
	$vk_like .= $form->field($model, 'vk_like_message_description')->textarea();
	$vk_like .= $form->field($model, 'vk_like_message_image')->textInput();
	...
	$vk_share .= $form->field($model, 'vk_share_url')->textInput();

	$vk_share .= $form->field($model, 'vk_share_title')->textInput(
			['value' => 'поделиться']
	);

	$vk_share .= $form->field($model, 'vk_like_message_title')->textInput();
	$vk_share .= $form->field($model, 'vk_like_message_description')->textarea();
	$vk_share .= $form->field($model, 'vk_like_message_image')->textInput();
	...
	$vk_subscribe .= $form->field($model, 'vk_subscribe_group_id')->textInput();

	$vk_subscribe .= $form->field($model, 'vk_subscribe_title')->textInput(
		['value' => 'поделиться']
	);
	...
	$ok_share .= $form->field($model, 'ok_share_url')->textInput();

	$ok_share .= $form->field($model, 'ok_share_title')->textInput(
		['value' => 'поделиться']
	);
	...
	$mail_share .= $form->field($model, 'mail_share_url')->textInput();

	$mail_share .= $form->field($model, 'mail_share_title')->textInput(
			['value' => 'поделиться']
	);

	$mail_share .= $form->field($model, 'mail_share_message_title')->textInput();
	$mail_share .= $form->field($model, 'mail_share_message_description')->textarea();
	$mail_share .= $form->field($model, 'mail_share_message_image')->textInput();
