<?php
	...
	class Screens implements ScreenInterface {
		...
		const CLASSES_NAMESPACE = 'common\modules\lockers\advanced\stats\fields\emaillocker';
		...
		public static function getScreens()
		{
			$screens = [
				...
				'bounces' => [
					...
					'chartClass' => self::CLASSES_NAMESPACE . '\BouncesStatsChart',
					'tableClass' => self::CLASSES_NAMESPACE . '\BouncesStatsTable'
				]
			];
