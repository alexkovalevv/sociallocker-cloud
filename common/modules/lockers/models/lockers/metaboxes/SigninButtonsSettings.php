	...
	class SigninButtonsSettings extends Model {
		...
		public function attributeLabels()
		{
			return [
				...
				'twitter_follow_user' => 'Ссылка на вашу страницу в Twitter',
		...
		public function attributeHints()
		{
			return [
				...
				'twitter_follow_user' => 'Впишите в поле сслыку на вашу страницу в Twitter (например, https://twitter.com/byonepress)',
