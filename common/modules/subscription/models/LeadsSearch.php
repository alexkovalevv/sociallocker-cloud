...
class LeadsSearch extends Leads
{
    ...
    {
        return [
            [['id', 'lead_email_confirmed', 'lead_subscription_confirmed', 'lead_item_id'], 'integer'],
            [['lead_display_name', 'lead_name', 'lead_family', 'lead_email', 'lead_date', 'lead_item_title', 'lead_referer', 'lead_confirmation_code', 'lead_temp'], 'safe'],
        ];
    }
