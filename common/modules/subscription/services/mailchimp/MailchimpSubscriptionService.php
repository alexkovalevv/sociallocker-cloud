<?php
namespace common\modules\subscription\services\mailchimp;

use Yii;
use common\modules\subscription\classes\Subscription;
use common\modules\subscription\services\mailchimp\libs\MailChimp;
...
class MailchimpSubscriptionService extends Subscription {
    ...
    public function initMailChimpLibs() {
        ...
        $this->apiKey = Yii::$app->lockersSettings->get('mailchimp_apikey', false);
