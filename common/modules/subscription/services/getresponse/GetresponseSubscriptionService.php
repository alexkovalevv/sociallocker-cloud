<?php
namespace common\modules\subscription\services\getresponse;

use Yii;
use yii\base\Exception;
use common\modules\subscription\classes\Subscription;
use common\modules\subscription\services\getresponse\libs\JsonRPCClient;
...
class GetresponseSubscriptionService extends Subscription {
    ...
    public function initGetResponseLibs( ) {
        ...
        $this->apiKey = Yii::$app->lockersSettings->get('getresponse_apikey', false);
